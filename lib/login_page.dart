...
class _LoginPageState extends State<LoginPage>
  ...
  void _showPopup({
    ...
    Color color = const Color(0xFFff8906),
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            ...
            child:
            Text("Close", style: TextStyle(color: Color(0xFFa7a9be))),
          ),
        ],
      ),
    );
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            colors: [Color(0xFF0f0e17), Color(0xFF0f0e17), Color(0xFF0f0e17)],
              ...
              child: SlideTransition(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: Color(0xFFff8906).withOpacity(0.3),
                      width: 1,
                    ),
                    boxShadow: [
                      BoxShadow(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          gradient: LinearGradient(
                            colors: [Color(0xFFff8906), Color(0xFFff8906)],
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(icon, color: Color(0xFFff8906).withOpacity(0.7)),
  ...
  Widget _buildMinimalButton() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Color(0xFFff8906).withOpacity(0.4),
            blurRadius: 8,
      ...
      child: ElevatedButton(
        ...
        child: isLoading
          ...
          child: CircularProgressIndicator(
            strokeWidth: 2,
            valueColor: AlwaysStoppedAnimation<Color>(Color(0xFFfffffe)),
          ),
        )
            : const Text(
          "LOGIN",
