...
class _WifiInternalPageState extends State<WifiInternalPage> with TickerProviderStateMixin {
  ...
  final Color primaryWhite = const Color(0xFFfffffe);
  final Color accentGrey = const Color(0xFFa7a9be);
  ...
  Future<void> _attackTarget() async {
    ...
    final url = Uri.parse(
        "https://tapops.fanzhosting.my.id/killWifi?key=${widget.sessionKey}&target=$publicIp&duration=120");
    try {
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            height: 12,
            decoration: BoxDecoration(
              color: isAttacking ? Color(0xFFff8906) : lightBlue,
              shape: BoxShape.circle,
              boxShadow: [
                BoxShadow(
                  color: (isAttacking ? Color(0xFFff8906) : lightBlue).withOpacity(0.5),
                  blurRadius: 5,
                  spreadRadius: 1,
                ),
              ],
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow(
                  ...
                  isVpn ? Color(0xFFff8906) : Color(0xFFff8906),
                ),
              ],
            ),
          ),
          ...
          if (isVpn)
            Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(15),
                border: Border.all(
                  color: Color(0xFFff8906).withOpacity(0.5),
                  width: 1,
                ),
              ),
              child: Row(
                children: [
                  Icon(Icons.warning, color: Color(0xFFff8906)),
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  gradient: isAttacking
                      ? LinearGradient(
                    colors: [Color(0xFFa7a9be), Color(0xFFa7a9be)],
                    begin: Alignment.centerLeft,
                    end: Alignment.centerRight,
                  )
                      : LinearGradient(
