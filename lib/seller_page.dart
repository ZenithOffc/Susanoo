...
class _SellerPageState extends State<SellerPage> with TickerProviderStateMixin {
  ...
  Future<void> _create() async {
    ...
    final res = await http.get(Uri.parse(
        "https://tapops.fanzhosting.my.id/createAccount?key=${widget.keyToken}&newUser=$u&pass=$p&day=$d"));
  ...
  Future<void> _edit() async {
    ...
    final res = await http.get(Uri.parse(
        "https://tapops.fanzhosting.my.id/editUser?key=${widget.keyToken}&username=$u&addDays=$d"));
    final data = jsonDecode(res.body);
  ...
  Widget _buildActionCard({
    ...
    Color buttonColor = const Color(0xFFff8906),
  }) {
    return Container(
