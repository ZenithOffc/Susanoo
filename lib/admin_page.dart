...
class _AdminPageState extends State<AdminPage> with TickerProviderStateMixin {
  ...
  final Color primaryDark = const Color(0xFF0f0e17);
  final Color primaryBlue = const Color(0xFF0f0e17);
  final Color accentBlue = const Color(0xFFff8906);
  final Color lightBlue = const Color(0xFFff8906);
  final Color cardDark = const Color(0xFF0f0e17);
  final Color cardDarker = const Color(0xFF0f0e17);
  final Color successGreen = const Color(0xFFff8906);
  final Color warningOrange = const Color(0xFFff8906);
  final Color dangerRed = const Color(0xFFff8906);
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('https://tapops.fanzhosting.my.id/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('https://tapops.fanzhosting.my.id/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final url = Uri.parse(
        'https://tapops.fanzhosting.my.id/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      message,
                      style: TextStyle(
                        color: Color(0xFFfffffe).withOpacity(0.8),
                        fontSize: 14,
                      ),
                    ),
                  ],
      ...
      child: Column(
        ...
        children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            color: Color(0xFFfffffe).withOpacity(0.7),
                            fontSize: 12,
                          ),
                        ),
                      ],
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      actions: [
                        TextButton(
                          ...
                          child: Text(
                            "Batal",
                            style: TextStyle(color: Color(0xFFfffffe).withOpacity(0.7)),
                          ),
                        ),
                        ElevatedButton(
          ...
          Text(
            ...
            style: TextStyle(
              color: Color(0xFFfffffe).withOpacity(0.6),
              fontSize: 12,
            ),
          ),
        ],
    ...
    return Row(
      ...
      children: [
        IconButton(
          ...
          color: currentPage > 1 ? accentBlue : Color(0xFFa7a9be),
        ),
          ...
          return Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: currentPage == page ? Color(0xFFfffffe) : Color(0xFFa7a9be),
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 8),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8),
                  side: BorderSide(
                    color: currentPage == page ? accentBlue : Color(0xFFfffffe).withOpacity(0.2),
                  ),
                ),
                elevation: 0,
              ),
        ...
        IconButton(
          ...
          color: currentPage < totalPages ? accentBlue : Color(0xFFa7a9be),
        ),
      ],
    );
  }
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            ...
            children: [
              Icon(
                icon,
                color: isSelected ? accentBlue : Color(0xFFfffffe).withOpacity(0.6),
                size: 24,
              ),
              const SizedBox(height: 4),
              Text(
            ...
            child: Column(
              ...
              children: [
                Icon(
                  ...
                  color: Color(0xFFfffffe).withOpacity(0.5),
                  size: 64,
                ),
                const SizedBox(height: 16),
                Text(
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: hint,
              hintStyle: TextStyle(color: Color(0xFFfffffe).withOpacity(0.5)),
